...
// TODO replace the Database['public']['Tables']['restaurants']['Row']['id'] with a proper type (Read the docs)
...
const RestaurantHeader = (props: RestaurantHeaderProps) => {
  const { gradient, handleOpenModal, handleDelete, restaurant } = props;
